...
function Hero() {
    return ( 
        <div className='container'>
            <div className='row'>
                  <p className='fs-3 mt-5 mb-4 p-5 text-center '>We pioneered the discount broking model in India. <br /> Now, we are breaking ground with our technology. </p>
            </div>
            <hr />
            <div className='row mt-5 p-5 text-muted fs-6'
